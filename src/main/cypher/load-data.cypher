...
(lungPartialSolution1:PartialSolution {
  id: "efb73a24-a4be-4755-a7b1-a6250727eaaa",
  solution: "OXY",
...
(lungPartialSolution2:PartialSolution {
  id: "b334b947-1296-48a1-8a34-dbf7a2cf4918",
  solution: "O2",
  response: "Incomplete!"
}),
...
(heartPartialSolution1:PartialSolution {
  id: "a2b82cb1-5117-46fe-988d-822dc1f79da6",
  solution: "HEART",
...
(heartPartialSolution2:PartialSolution {
  id: "62aff225-bee9-4fa8-a416-6bba51e2f87b",
  solution: "OXYGEN",
...
(team1:Team {
  id: "66af7be3-7240-48a9-9e19-f2ff0e885910",
  name: "Team 1"
}),

(player1:Person {
  id: "d80d2554-9e48-47b4-a52b-e8b4ba22cc16",
  name: "Player 1"
}),
(player1)-[:MEMBER_OF]->(team1),

(player2:Person {
  id: "ddf34617-df25-465f-bb29-4d0424373033",
  name: "Player 2"
}),
...
(team1)-
  [:SOLVED {id:"b072e551-4f7f-4cab-bd1d-acffeef4dabe", start: datetime('2015-06-24T12:52:01.001+0100'), end: datetime('2015-06-24T13:28:55.821+0100'), points: 11}]
->(lungs),

(team1)-
  [:SOLVED {id: "214941d3-98d8-4378-b9f1-c69490e59e26", start: datetime('2015-06-24T13:40:32.987+0100'), end: datetime('2015-06-24T15:52:01.001+0100'), points: 5}]
->(heart),

(team1)-[:BOUGHT]->(lungHint1),

(team2:Team {
  id: "4090c00c-1219-4cf3-877e-146f345ec498",
  name: "Team 2"
}),

(player3:Person {
  id: "9434d65c-a693-4dac-95fd-5496ebd32650",
  name: "Player 3"
}),
...
(player4:Person {
  id: "5efd7a47-98f7-4c4d-87e9-ba7434c4afa6",
  name: "Player 4"
}),
...
(team2)-
  [:SOLVED {
    id: "34e52114-9ca9-4981-9b9c-99ca1ab8dd0e",
...
(team2)-
  [:SOLVED {id: "7a5a4094-a751-4b72-908c-22a2244a4881", start: datetime('2015-06-24T14:02:28.002+0100')}]
->(heart),
